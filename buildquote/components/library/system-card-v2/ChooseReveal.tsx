...
// Choose screen — ported from Data Studio's System Card V2
// (components/system-card-v2/ChooseReveal.tsx), retyped against this app's
// own LibraryColour/LibraryProfile instead of SystemCardColour/
// SystemCardProfile (same fields, different type names).
//
...
import type { LibraryColour, LibraryProfile } from '@/lib/data/getSystems'
