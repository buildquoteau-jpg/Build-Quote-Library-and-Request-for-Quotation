...
// out of the Stockists accordion tab. V1 (SystemCardUI.tsx) had this
// button sitting in the open page flow, never buried behind a collapsed
// tab; System Card V2's accordion had nested it inside Stockists, which
// Melia flagged as the button no longer being "always visible — never
// buried in a tab." Rendered directly under the accordion bars, not
// inside any of them — Stockists itself now holds only the local
// stockist list.
