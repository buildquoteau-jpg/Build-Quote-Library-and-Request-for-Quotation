...
// against this app's own LibrarySystem instead of SystemCardSystem (same
// fields, different type name). Real photography only: hero_image_url +
...
export function Cover({ manufacturer, system, cardUrl }: {
  ...
  // Below 3 photos a grid just looks like a half-empty box — stay on the
  // single-swipe layout at every width in that case.
