...
-- Supabase Storage bucket for logos (run separately in dashboard if needed)
-- insert into storage.buckets (id, name, public) values ('builder-logos', 'builder-logos', true)
