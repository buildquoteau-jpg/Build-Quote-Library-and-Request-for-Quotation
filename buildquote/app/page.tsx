export default function Home() {
  return (
    <main className="min-h-screen bg-page flex flex-col items-center px-6 pt-16 pb-12 lg:pt-24 xl:pt-28">
      ...
      <a
        href="/rfq"
        className="bg-brand hover:bg-brand-hover text-white font-bold text-lg lg:text-xl px-10 lg:px-16 py-4 lg:py-5 rounded-2xl transition-colors text-center shadow-[0_10px_24px_rgba(249,115,22,0.22)] w-full max-w-xs lg:max-w-sm"
      >
        Get Started
      </a>
      ...
      <div className="mt-4 flex flex-col items-center gap-2.5 w-full max-w-xs lg:max-w-sm">
        <a
          href="/register"
